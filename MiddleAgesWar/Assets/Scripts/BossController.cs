...
public class BossController : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        //////////////////////////////////////////////////////////////////
        // 시작시 쿨타임 조정용
        mNormalAttackCurCool = 0.0f;
        mSlashCurCool = 0.0f;
        mJumpAttackCurCool = 0.0f;
        //////////////////////////////////////////////////////////////////
        //
    ...
    void Update()
    {
        ...
        // 쿨타임 증가
        mNormalAttackCurCool += Time.deltaTime;
        mSlashCurCool += Time.deltaTime;
        mJumpAttackCurCool += Time.deltaTime;
        ...
        switch (mBossState)
        {
            ...
            case BossState.TRACING:
                ...
                mNormalAttackCurCool = mNormalAttackCoolTime;
                break;
    ...
    void ChangeState()
    {
        ...
        if (!(IsAttacking) && // 공격중이 아닐때
            (mJumpAttackCurCool >= mJumpAttackCoolTime)
            )
        {
        ...
        // 슬래쉬 공격 체크
            ...
            (mSlashCurCool >= mSlashCoolTime) && // 현재 쿨타임이 정해진 쿨타임을 충족했을 때  &&
            !(IsAttacking) // 공격중이 아닐때
            )
        {
        ...
        // 일반공격 체크
            ...
            (mNormalAttackCurCool >= mNormalAttackCoolTime) && // 현재 쿨타임이 정해진 쿨타임을 충족했을 때 &&
            !(IsAttacking) // 공격중이 아닐때
            )
        {
    ...
    void SkillEnd(int attackType)
    {
        ...
        switch (attackType)
        {
            case 1:
                ...
                mNormalAttackCurCool = 0.0f; // 기본공격 쿨타임 초기화.
                break;
            case 2:
                mAnimator.SetBool("IsSlash", false);
                mSlashCurCool = 0.0f; // 슬래쉬 공격 쿨타임 초기화.
                mNormalAttackCurCool = 0.0f;
                break;
            case 3:
